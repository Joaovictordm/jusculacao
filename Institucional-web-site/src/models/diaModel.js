...
function tirarCaloria(id_usuario, contagem){
    let instrucao = `UPDATE meta_dia SET contagem_atual = contagem_atual - ${contagem}, updated_at = NOW() WHERE id_usuario = ${id_usuario} AND id_meta = CURDATE()`;
